...
from app.agents.test_understanding_agent import test_understanding_node
...
def build_execution_graph() -> StateGraph:
    ...
    graph.add_node("understand", test_understanding_node)
    ...
    graph.add_edge("understand", "parse")
